...
(function () {
    ...
    // litro al lado es el que da la escala de lo que se hizo ("1.240 ml" no dice
    ...
    // celeste, en iPhone es blanca— y ninguno acompaña la paleta cálida de la
    // app. Estos son dibujos propios, con el mismo lenguaje que el resto de los
    // íconos: caja de 24×24, trazo en currentColor (así heredan el color de la
    // tarjeta) y un `.relleno` translúcido para el segundo tono.
    var ICO_KPI = {
    ...
    // no la tenés en casa. Puede estar congelada allá (el back up) o ya
    ...
    // (los checkbox son la fuente de verdad de lo que la mamá tildó) y se
    // repinta al dibujar las listas y con cada tilde.
    ...
    function renderTodo() {
        ...
        pintarBotonFreezar();
        // El gráfico se repinta con cada payload fresco: si la mamá acaba de
        // cargar una bolsita, ya la ve reflejada sin recargar la página.
        ...
        .then(function (data) {
            if (!data.ok) {
                throw new Error(data.error ||
                    T('No pudimos enviar tu sugerencia. Lo que escribiste sigue acá: probá de nuevo en un momento.'));
            }
    ...
    function init() {
        ...
        // ayudantes de acá para que traduzca y formatee igual que el resto de la
        // app (y no tenga su propia versión de "120 ml" ni de "12 ago").
